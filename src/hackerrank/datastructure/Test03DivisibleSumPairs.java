...
public class Test03DivisibleSumPairs {
    public static void main(String[] args) {
        ...
        System.out.println("Test case 1 Expected 5 and then result is " + result);
        int result2 = divisibleSumPairs(6, 5, Arrays.asList(1, 2, 3, 4, 5, 6));
        System.out.println("Test case 2 Expected 3 and then result is " + result2);
    }
